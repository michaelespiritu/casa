...
class CasaMetaBoxAndFields {
	...
	function __construct(){
		...
		add_action( 'add_meta_boxes', [$this, 'casa_add_metabox'] );
		add_action( 'save_post', [$this, 'casa_meta_save' ] );
...
$casaMetaBoxAndFields = new CasaMetaBoxAndFields();
